...
public class TileTest {
    ...
    public void testGetEdgeWithNorthOrientation(){
        Edge topEdge = new Edge(new Zone(Topology.CITY));
        Tile tile1 = new Tile(topEdge, 
                    new Edge(new Zone(Topology.FIELD)), 
                    new Edge(new Zone(Topology.FIELD)), 
                    new Edge(new Zone(Topology.FIELD)),
                    Orientation.NORTH);
    ...
    public void testCompatibilityOfTwoCompatibleTilesNoRoads(){
        Tile tile1 = new Tile(new Edge(new Zone(Topology.CITY)), 
                            new Edge(new Zone(Topology.FIELD)), 
                            new Edge(new Zone(Topology.FIELD)), 
                            new Edge(new Zone(Topology.FIELD)));

        Tile tile2 = new Tile(new Edge(new Zone(Topology.FIELD)), 
                            new Edge(new Zone(Topology.FIELD)), 
                            new Edge(new Zone(Topology.CITY)), 
                            new Edge(new Zone(Topology.FIELD)));
    ...
    public void testCompatibilityOfTwoCompatibleTilesWithRoads(){
        Tile tile1 = new Tile(new Edge(new Zone(Topology.FIELD), new Zone(Topology.FIELD)), 
                            new Edge(new Zone(Topology.FIELD), new Zone(Topology.CITY)),
                            new Edge(new Zone(Topology.FIELD), new Zone(Topology.FIELD)), 
                            new Edge(new Zone(Topology.CITY), new Zone(Topology.FIELD)));

        Tile tile2 = new Tile(new Edge(new Zone(Topology.CITY), new Zone(Topology.CITY)), 
                            new Edge(new Zone(Topology.FIELD), new Zone(Topology.FIELD)),
                            new Edge(new Zone(Topology.FIELD), new Zone(Topology.CITY)), 
                            new Edge(new Zone(Topology.CITY), new Zone(Topology.FIELD)));
    ...
    public void testCompatibilityOfTwoIncompatibleTilesWithAndWithoutRoad(){
        ...
        Tile tile2 = new Tile(new Edge(new Zone(Topology.FIELD), new Zone(Topology.FIELD)), 
                            new Edge(new Zone(Topology.FIELD)),
                            new Edge(new Zone(Topology.FIELD), new Zone(Topology.FIELD)), 
                            new Edge(new Zone(Topology.FIELD), new Zone(Topology.FIELD)));
    ...
    public void testCompatibilityOfTwoCompatibleTilesWithRotation(){
        Tile tile1 = new Tile(new Edge(new Zone(Topology.FIELD)), 
                            new Edge(new Zone(Topology.FIELD)), 
                            new Edge(new Zone(Topology.CITY)), 
                            new Edge(new Zone(Topology.FIELD)),
                            Orientation.SOUTH);
    ...
    public void testConnectTwoRoadsEdgesWithRoads() throws NoRoadException{
        Tile tile = new Tile(new Edge(new Zone(Topology.CITY), new Zone(Topology.FIELD)), 
                            new Edge(new Zone(Topology.FIELD), new Zone(Topology.FIELD)),
                            new Edge(new Zone(Topology.FIELD), new Zone(Topology.FIELD)), 
                            new Edge(new Zone(Topology.FIELD), new Zone(Topology.FIELD)));
    ...
    public void testConnectTwoRoadsWithEdgesWithoutRoads() {
        Tile tile = new Tile(new Edge(new Zone(Topology.FIELD)), 
                            new Edge(new Zone(Topology.FIELD)), 
                            new Edge(new Zone(Topology.FIELD)), 
                            new Edge(new Zone(Topology.FIELD)));
    ...
    public void testGetExitRoadWithEdgeWithoutRoad() {
        Tile tile = new Tile(new Edge(new Zone(Topology.CITY)), 
                            new Edge(new Zone(Topology.FIELD)), 
                            new Edge(new Zone(Topology.FIELD)), 
                            new Edge(new Zone(Topology.FIELD)));
    ...
    public void testTerminateRoadWithEdge() throws NoRoadException{
        Tile tile = new Tile(new Edge(new Zone(Topology.FIELD), new Zone(Topology.FIELD)), 
                            new Edge(new Zone(Topology.FIELD), new Zone(Topology.FIELD)),
                            new Edge(new Zone(Topology.FIELD), new Zone(Topology.FIELD)), 
                            new Edge(new Zone(Topology.FIELD), new Zone(Topology.FIELD)));
